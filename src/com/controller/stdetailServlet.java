...
@WebServlet("/stdetailServlet")
public class stdetailServlet extends HttpServlet {


  private static final long serialVersionUID = 1L;

  private static Logger logger = Logger.getLogger(stdetailServlet.class.getName());
...
request.getSession().getAttribute("userid");
    request.getRequestDispatcher("/WEB-INF/JSP/stdetail.jsp").forward(request, response);
    return;
