        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tile">
                    ...
                    <p>首先感谢选择本高中学生社团服务管理一体化平台！</p>
                    <p>本高中学生社团服务管理一体化平台意在为高中提供数字化的社团管理服务。提供社团创建、注销活动申请、社团事务审批等功能，方便对高中社团进行数字化管理，也为同学们的社团建设进行服务。点击 <a href="#" target="_blank">这里</a> 访问了解网站的版本资料.</p>
                    <p>本平台为第六学期项目实践作业，由南田中学信息与计算机工程学院2016级软件工程2班张峻巍等人开发完成。点击<a href="mailto:1174681078@qq.com" target="_blank">这里</a>向开发者发送邮件反馈问题。
