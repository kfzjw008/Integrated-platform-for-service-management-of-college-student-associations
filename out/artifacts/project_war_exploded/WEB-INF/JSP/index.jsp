...
<head >
    ...
    <title>高中学生社团服务管理一体化平台——登录</title>
</head>
<body>
<div >
    <div>
            ...
            <div class="login-box">
                <form class="login-form" action="htindexServlet"  method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="username" type="text" placeholder="请输入账号" >
                ...
                <form class="forget-form" action="AddUserServlet"  method="post" >
                    ...
                    <div class="form-group">
                        <label class="control-label">账号</label>
                        <input class="form-control" type="text" placeholder="请输入账号" name="schoolid">
                    </div>
                    <div class="form-group btn-container">
