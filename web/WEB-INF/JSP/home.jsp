...
<div id="form1">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            <li><a class="app-menu__item active" href="home"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">首页</span></a></li>
    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="tile">
                    <h3 class="tile-title">V1.0版本功能简介</h3>
                    <ul>
                        <li>支持创建社团、注销社团</li>
                        <li>支持浏览社团列表</li>
                        <li style="">支持对个人资料进行修改.</li>
                        <li>支持更多活动申请、场地申请、人员资金管理等功能。</li>
                    </ul>
                    <p>    后期还会开发协会荣誉功能，十佳社团在线申请投票功能，协会指导老师用户功能等，敬请期待！</p>

                </div>
            </div>
            <div class="col-md-6">
                <div class="tile">
                    <h3 class="tile-title">使用简介</h3>
                    <p>首先感谢选择本高校学生社团服务管理一体化平台！</p>
                    <p>本高校学生社团服务管理一体化平台意在为高校提供数字化的社团管理服务。提供社团创建、注销活动申请、社团事务审批等功能，方便对高校社团进行数字化管理，也为同学们的社团建设进行服务。点击 <a href="#" target="_blank">这里</a> 访问了解网站的版本资料.</p>
                    <p>本平台为第六学期项目实践作业，由东北林业大学信息与计算机工程学院2016级软件工程2班张峻巍等人开发完成。点击<a href="mailto:1174681078@qq.com" target="_blank">这里</a>向开发者发送邮件反馈问题。
                        版权所有 侵权必究  联系邮箱 1174681078@qq.com</p>
                </div>
            </div>
        </div>
    </main>
