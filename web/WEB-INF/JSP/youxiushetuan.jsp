...
<div id="form1" runat="server">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html" style="font-size:13px">高校学生社团服务管理一体化平台</a>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="ziliaoxiugais"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">个人中心</span></a></li>
        </ul>
    </aside>
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-dashboard"></i> 优秀社团</h1>
                <p>上一年度优秀社团！</p>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-condensed"  >
                        ...
                        <c:forEach items="${shetuan}" var="u">
                            <tr>
                                ...
                                <td>${u.telephone }</td>
                                <td>${u.wechat }</td>
                                <td><a href="stdetailServlet?uid=${u.id}">详情</a></td>
                            </tr>
                        </c:forEach>
