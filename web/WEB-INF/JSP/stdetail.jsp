...
<div id="form1" runat="server">
    ...
    <main class="app-content">
        <div class="row user">
            <div class="col-md-12">
                <div class="profile">
                    <div class="info"><img class="user-img" src="pic/logo.png">
                        <h4>
            ...
            <div class="col-md-3">
                <div class="tile p-0">
                    <ul class="nav flex-column nav-tabs user-tabs">
                        <li class="nav-item"><a class="nav-link active" href="#shetuanxinxiweihu" data-toggle="tab">社团信息</a></li>
                        <li class="nav-item"><a class="nav-link" href="#huodonghechangdishenqing" data-toggle="tab">加入社团</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="huodonghechangdishenqing">
                        <div class="tile shetuanhuodong">
                            <h4 class="line-head">加入社团</h4>
                            <form class="jumbotron" action="AddstuserServlet"  method="post">
                                <h1 class="display-3">加入社团，只需一步</h1>

                                <p>点击以下加入按钮立刻加入社团。加入社团后自动成为社团会员，开始享受会员权利，并请在七日内主动联系负责人上交会费。加入社团视为已经阅读并了解学校社团联合会章程和所加入社团章程。出现纠纷一切责任由加入者自行承担。.</p>
                                <Button ID="Button1"  action="AddstuserServlet" href="AddstuserServlet" class="btn btn-primary btn-lg" type="submit" >加入本社团</Button>
